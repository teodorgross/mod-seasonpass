-- mod-battlepass v4: 20 Saison-Erfolge
DROP TABLE IF EXISTS `battlepass_achievements`;
CREATE TABLE `battlepass_achievements` (
...
INSERT INTO `battlepass_achievements` (`id`,`kind`,`goal`,`points`,`name`,`name_en`) VALUES
