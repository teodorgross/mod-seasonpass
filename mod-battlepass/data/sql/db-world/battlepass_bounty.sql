-- mod-battlepass v4: Kopfgeld des Tages
DROP TABLE IF EXISTS `battlepass_bounty`;
CREATE TABLE `battlepass_bounty` (
...
INSERT INTO `battlepass_bounty` (`id`,`entry`,`points`,`name`,`name_en`,`zone`,`zone_en`) VALUES
