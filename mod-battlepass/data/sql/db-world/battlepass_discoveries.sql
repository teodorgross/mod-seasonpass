-- mod-battlepass v4: Verlorene Orte (Entdeckungs-System)
DROP TABLE IF EXISTS `battlepass_discoveries`;
CREATE TABLE `battlepass_discoveries` (
...
INSERT INTO `battlepass_discoveries` (`id`,`zone`,`points`,`name`,`name_en`) VALUES
