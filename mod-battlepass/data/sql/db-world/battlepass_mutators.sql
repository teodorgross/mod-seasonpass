-- mod-battlepass v4: Wochen-Mutatoren (Open-World-Affixe)
DROP TABLE IF EXISTS `battlepass_mutators`;
CREATE TABLE `battlepass_mutators` (
...
INSERT INTO `battlepass_mutators` (`id`,`kind`,`value`,`name`,`name_en`) VALUES
