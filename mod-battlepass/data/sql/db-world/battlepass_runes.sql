-- mod-battlepass v4: 24 Runen (12 Dauerbuffs + 12 neue Fähigkeiten)
DROP TABLE IF EXISTS `battlepass_runes`;
CREATE TABLE `battlepass_runes` (
...
INSERT INTO `battlepass_runes` (`id`,`classmask`,`kind`,`spell`,`cost`,`name`,`name_en`) VALUES
