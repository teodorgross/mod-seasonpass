-- mod-battlepass v4: Teleport-Ziele der Traumpfadhüterin
DROP TABLE IF EXISTS `battlepass_teleports`;
CREATE TABLE `battlepass_teleports` (
...
INSERT INTO `battlepass_teleports` (`id`,`name`,`name_en`,`map`,`x`,`y`,`z`,`o`) VALUES
