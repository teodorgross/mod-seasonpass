-- mod-battlepass v4: Zonen-Events
DROP TABLE IF EXISTS `battlepass_zones`;
CREATE TABLE `battlepass_zones` (
...
INSERT INTO `battlepass_zones` (`id`,`zone`,`name`,`name_en`) VALUES
