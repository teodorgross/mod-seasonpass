-- mod-seasonpass v4: 40 Wochenziel-Definitionen (zweisprachig)
DROP TABLE IF EXISTS `seasonpass_weekly`;
CREATE TABLE `seasonpass_weekly` (
...
INSERT INTO `seasonpass_weekly` (`id`,`type`,`goal`,`points`,`name`,`name_en`) VALUES
